...
extern int user_login(int sockfd, tree_head_t *user_table, const char *login_mes);
extern int user_logoff(int sockfd, tree_head_t *user_table, const char *logoff_mes);
